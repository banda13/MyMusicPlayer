 ...
 */
public class MyPlayLists extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.myplaylists_layout, null);
        ...
        tracks = ListActivity.MAdapter.getTmpList();
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new ItemRecycleView(myContext.getSupportFragmentManager(), 2, tracks));
